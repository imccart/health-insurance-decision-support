...
# the reduction of the premium total for administrative costs from benefit year
# 2018. The premium total itself is premiums collected at the observed premiums
# (ra_premium_total in ra.R).
