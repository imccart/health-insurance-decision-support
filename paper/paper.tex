...
Each insurer $f$ chooses base premiums $p_{jmt}$ and agent commissions for each of its plans to maximize expected variable profit
\begin{equation}
\label{eqn:profit}
...
\end{equation*}
where $a_{it}^B$ indicates agent-assisted enrollment and $q_{ijt}$ are the choice probabilities from Equation~\eqref{eqn:choice_probs}.
